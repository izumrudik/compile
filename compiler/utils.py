...
def extract_module_from_file_path(file_path:str, config:Config, module_path:str|None = None, place:'Place|None' = None) -> 'nodes.Module':
	...
	if not os.path.exists(file_path):
		config.errors.critical_error(ET.MODULE, place, f"module '{module_path}' was not found at '{file_path}'")
