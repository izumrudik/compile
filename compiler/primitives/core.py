...
class ET(Enum):# Error Type
	...
	BOUND_FUN_ARG       = auto()
	BOUND_FUN_ARGS      = auto()
	BOUND_STR_MAGIC     = auto()
	BOUND__STR__RET     = auto()
	CALLABLE            = auto()
	CALL_ARG            = auto()
	CALL_ARGS           = auto()
	CALL_COMMA          = auto()
	...
	INVALID_BIN_OP_LEFT = auto()
	INVALID_BIN_OP_RIGHT= auto()
	INVALID_CALL_ARG    = auto()
	INVALID_CAST_TYPE   = auto()
	INVALID_CAST_VALUE  = auto()
	INVALID_DECLARATION = auto()
	INVALID_ENUM_ITEM   = auto()
	INVALID_FUN_ARG     = auto()
	INVALID_FUN_RETURN  = auto()
	INVALID_GENERIC_FILL= auto()
	INVALID_MATCH       = auto()
	INVALID_RETURN      = auto()
	INVALID_SAVE        = auto()
	INVALID_STRUCT_VAR  = auto()
	INVALID_SUBSCRIPT   = auto()
	INVALID_TEMPLATE_VAL= auto()
	INVALID_TYPE_DEF    = auto()
	INVALID_UNARY_OP    = auto()
	INVALID_USE_ARG     = auto()
	INVALID_USE_RETURN  = auto()
	INVALID_VAR         = auto()
	INVALID_VSAVE       = auto()
	LLVM_DIS            = auto()
	MAIN_ARGS           = auto()
